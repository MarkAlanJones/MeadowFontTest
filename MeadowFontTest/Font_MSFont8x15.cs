...
namespace Meadow.Foundation.Graphics
{
    ...
    public class MSFont8x15 : FontBase
    {
        ...
        private readonly byte[] font_8x15 ={
/*   0 ' ' */
    /* 00000000 */   0,
    /* 00000000 */   0,
    /* 00000000 */   0,
...
/*  be 'Þ' */
    ...
    /* 01111100 */  0x7c,
        ...
        public override byte[] this[char character]
        {
            get
            {
                return Font_GetGlyph(character);
            }
        }

        private byte[] Font_GetGlyph(char c)
        {
            int cc = c & 0xFF;
            ...
            if (cc > 0x1F && cc < 0x7F) 
                ...
                cc = 0; /* non-printable --> space */

            var result = new byte[HEIGHT];
            for (int x = 0; x < HEIGHT; x++)
                result[x] = Reverse(font_8x15[cc * Height + x]);
